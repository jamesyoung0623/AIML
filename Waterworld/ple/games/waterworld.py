...
class WaterWorld(PyGameWrapper):
	...
	def __init__(self,
		...
		self.CREEP_COLORS = [(40, 140, 40), (150, 95, 95), (150,150,50)]
		radius = percent_round_int(width, 0.01)
	...
	def init(self):
		...
		for i in [0,1,2]:
			for _ in range(self.N_CREEPS//3):
				self._add_creep(i)
	...
	def step(self, dt):
		...
		for creep in hits:
			...
			add_score = score(creep.reward,self.getGameState())
